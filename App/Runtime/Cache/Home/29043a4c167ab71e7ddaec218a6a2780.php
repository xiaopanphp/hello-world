		...
		<div class="login">
			...
			<div class="right">
					<table class="table">
						...
						<tr>
							<td><img id="pwd-img" src="/Public/Home/images/login/2015-04-20_105837.png"><input id="pwd" type="password" name="password" placeholder="请输入密码" id="pwd"></td>
						</tr>
						<tr>
							<td>
...
<script type="text/javascript">
	$(function(){
		...
		$("#login").click(function(){
			...
			$.post("<?php echo U('login/login');?>",{code:verify,user:user,password:password,remember:remember},function(re){
				if(re == 1){
